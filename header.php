          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li <?php if ($getMenu==''){echo 'class="active"';}?>><a href="/">Home</a></li>
                <li <?php if ($getMenu=='sobre'){echo 'class="active"';}?>><a href="/sobre">Sobre</a></li>
                <li <?php if ($getMenu=='contato'){echo 'class="active"';}?>><a href="/contato">Contato</a></li>                
